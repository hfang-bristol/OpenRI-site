...
- `Step 4`: specifying the top regulatory genes to identify ontology terms based on which ontology.
...
- Under the tab `Output: Plots`, two output plots `Dotplot` and `Forest plot` illustrates enriched ontology terms. Also provided are the downloadable PDF files.
